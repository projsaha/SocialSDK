...
(function() {
	...
	this.require = {
		packages: [
	   		{
	   			name: 'dojo',
	   			location: '../sbt.dojo180/dojo',
	   			lib: '.'
	   		},
	   		{
	   			name: 'dijit',
	   			location: '../sbt.dojo180/dijit',
	   			lib: '.'
	   		},
	   		{
	   			name: 'dojox',
	   			location: '../sbt.dojo180/dojox',
	   			lib: '.'
	   		},
	   		{
	   			name: 'sbt',
